export default {
  ...
  cancelApplicationMessage: '这将取消待处理的证书申请，确定继续吗？',
  cancelApplicationTitle: '取消申请',
  cancelRenewButton: '取消续期',
  certificateStillPending: '证书仍处于待处理状态',
  clientId: '客户端 ID',
  clientSecret: '客户端密钥',
  ...
  dnsValidationConfig: 'DNS 验证配置',
  downloadFailed: '下载失败',
  errorMessage: '错误信息',
  errorsAndWarnings: '错误与警告',
  expand: '展开',
  expiresToday: '今天过期',
  expiresTomorrow: '明天过期',
  keepApplicationButton: '保留申请',
