export default {
  ...
  dialogs: {
    ...
    recreatePreparing: '正在准备重建...',
    recreateInProgress: '正在重建中，请稍候...',
  ...
  healthCheck: {
    ...
    checkCommandPlaceholder: '请输入检查命令',
  ...
  monitorDialog: {
    ...
    write: '写入',
    detailedStats: '详细统计',
    totalUsageTime: '总使用时间',
    systemUsageTime: '系统态时间',
    userUsageTime: '用户态时间',
    coreCount: '核心数',
    perCoreUsage: '每核心使用率',
    core: '核心',
  ...
  containerDetail: {
    ...
    restartSuccess: '重启成功',
    restartFailed: '重启失败',
    forceDeleteConfirm: '确认强制删除',
    forceDeleteTitle: '强制删除',
    forceDeleteButton: '强制删除',
    deleteFailed: '删除失败',
    containerUpdated: '容器已更新',
